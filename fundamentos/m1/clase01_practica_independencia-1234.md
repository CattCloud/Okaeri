...
![TAB del ejercicio 1-2-3-4: trastes 1 a 4 en cada cuerda, empezando por la 6ª, con la leyenda de qué dedo usa cada traste.](img/clase01-tab-1234.png)
...
El ejercicio del profe es el correcto — no lo cambio. Le agrego tres detalles que las buenas escuelas suman y que multiplican su efecto:

1. **Presión mínima.** Una vez al día: pisa una nota, aflójala hasta que zumbe, y vuelve a apretar **apenas lo justo** para que suene limpia. Así aprendes cuánta fuerza se necesita de verdad (mucha menos de la que crees) y no entrenas tensión.
2. **Dedos cerca.** Los dedos que no están pisando se quedan **a menos de 1 cm de las cuerdas**, no volando lejos. Ahí está la mitad de la independencia.
3. **El oído manda.** Si una nota sale sucia, no la dejes pasar: repítela sola 2-3 veces limpia y sigue. Repetir sucio graba sucio.

## Hasta cuándo

Es **tarea semanal**: se practica todos los días hasta la clase 2 (martes 08-sep). No "se aprueba" — este ejercicio te va a acompañar meses como calentamiento. Si el profe pide video al grupo de WhatsApp, graba la **versión 3** (es donde se ve el trabajo).

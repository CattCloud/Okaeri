...
- **Canto (jueves 8-10 pm, misma academia, grupo de 3-4):** matriculado 2026-09-03. **Okaeri es de música, no de un instrumento: el canto es el segundo mapa.** Temario en `contexto/plan_estudio/temario_canto.md` (8 módulos / 40 secciones, de cero) y sílabo en `silabo_academia_canto_basico1.md`. El veto "canto en paralelo" queda retirado; lo sustituye una regla de tiempo (el piso de guitarra no se negocia). **La integración estructural (carpetas, dos marcadores, dos academias, dos estados por pieza) está propuesta y pendiente de aprobación** — no mover archivos hasta entonces. El material se redacta solo para el usuario.
...
- **Pendiente del usuario:** importar el mazo Anki nuevo · lista de canciones de la banda · aprobar la integración estructural del canto (puntos en `PROMPT.md`) · fecha de la primera clase de canto y su reporte.
